...
import 'package:YDsync/core/ui/widgets/error_dialog.dart';
import 'package:YDsync/core/ui/widgets/flushbar.dart';
  ...
  ErrorHandler(BuildContext context) : _context = context {
    _defaultErrorHandlers = {
      NoConnectionException: (e) {
        _doWithLock(() => showTopPopUp(context: context, title: S.common.error, message: S.api_error.no_connection));
      },
    };
  }
