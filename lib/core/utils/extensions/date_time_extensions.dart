...
extension DateTimeExt on DateTime {
  ...
  int nightCount(DateTime other) {
    var startDate = other;
    var endDate = this;
    var timeDiff = endDate.millisecondsSinceEpoch - startDate.millisecondsSinceEpoch;
  ...
  DateTime get getTimeEndMonth {
    return DateTime(year, month, DateUtils.getDaysInMonth(year, month), 23, 59, 59, 999, 999);
  }

  bool isBetween(DateTime? date1, DateTime? date2) {
    if (date1 == null || date2 == null) return false;
    return isAfter(date1) && isBefore(date2) || isAtSameMomentAs(date1) || isAtSameMomentAs(date2);
  }
