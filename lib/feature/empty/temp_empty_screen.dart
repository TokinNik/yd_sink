...
import 'package:YDsync/feature/empty/bloc/temp_empty_bloc.dart';
...
class TempEmptyScreen extends StatelessWidget implements AutoRouteWrapper {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<TempEmptyScreenBloc, TempEmptyScreenState>(builder: _buildScreen, listener: _blocListener);
  }
  ...
  Widget wrappedRoute(BuildContext context) {
    return BlocProvider<TempEmptyScreenBloc>(create: (c) => TempEmptyScreenBloc(), child: TempEmptyScreen(deep: deep));
  }
}
